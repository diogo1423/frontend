                    ...
                    <form id="form-categoria" class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-6 gap-2 p-3 bg-slate-50 dark:bg-slate-700 rounded-lg max-h-40 overflow-y-auto">
                                <button type="button" class="icone-btn p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-600 text-xl" data-icone="💰">💰</button>
                                <button type="button" class="icone-btn p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-600 text-xl" data-icone="🏠">🏠</button>
                                <button type="button" class="icone-btn p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-600 text-xl" data-icone="🚗">🚗</button>
                                <button type="button" class="icone-btn p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-600 text-xl" data-icone="🍔">🍔</button>
                                <button type="button" class="icone-btn p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-600 text-xl" data-icone="⚕️">⚕️</button>
                                <button type="button" class="icone-btn p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-600 text-xl" data-icone="🎓">🎓</button>
                                <button type="button" class="icone-btn p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-600 text-xl" data-icone="✈️">✈️</button>
                                <button type="button" class="icone-btn p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-600 text-xl" data-icone="🛒">🛒</button>
                                <button type="button" class="icone-btn p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-600 text-xl" data-icone="💡">💡</button>
                            ...
                            <p class="text-xs text-slate-500 mt-1">Ícone selecionado: <span id="preview-icone">💰</span></p>
                        </div>
